...
<div id="wrap">
    ...
    <div class="header">
        <div class="logo"><a href="${base}/book/indexAction.do"><img src="${base}/images/logo.gif" alt="" title="" border="0"/></a></div>
        <div id="menu">
            <ul>
    ...
    <div class="center_content">
        <div class="left_content">
            <div class="title"><span class="title_icon"><img src="${base}/images/bullet1.gif" alt="" title=""/></span>关于我们</div>
            ...
            <div class="feat_prod_box_details">
                <p class="details">
                    ...
                    <br/><br/>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;在图书品类，天智占据了线上市场份额的50%以上，同时图书不但领先市场占有率43.5%。天智的图书订单转化率高达25%，远远高于行业平均的7%，这意味着每四个人浏览天智，就会产生一个订单。能做到图书零售第一，天智的杀手锏有许多，比如全品种上架、退货率最低、给出版社回款最快，也正是依靠这些优势，出版社给天智的进货折扣也最低，天智也因此有价格竞争优势。数据显示，包括平台图书的销售业务在内，天智图书SKU总数达到400万种，其中100-200万为外文书，自营图书SKU也有100万种之多。<br/><br/>
        ...
        <div class="right_content">
            ...
            <div class="right_box">
                ...
                <div class="title"><span class="title_icon"><img src="${base}/images/bullet4.gif" alt="" title=""/></span>推荐图书
                </div>
            ...
            <div class="right_box">
                ...
                <div class="title"><span class="title_icon"><img src="${base}/images/bullet5.gif" alt="" title=""/></span>图书分类
                </div>
                ...
                <div class="title"><span class="title_icon"><img src="${base}/images/bullet6.gif" alt="" title=""/></span>合作伙伴
                </div>
    ...
    <div class="footer">
        <div class="left_footer"><img src="${base}/images/footer_logo.gif" alt="" title=""/><br/> <a href="http://csscreme.com"><img
